...
### Recommended upgrade sequence to Marello 5.0
...
#### Update sequence to 5.0 additional step(s)
If you are going to upgrade from a Marello version lower than 4.2.x, please update to the latest 4.2.x version first!
This allows you to transition to 5.0 more easily and prevent issues during install. This step **is** necessary for a smooth transition during the changes made from the old Customer and new Customer
