    ...
    stages {
        stage('Building') {
            steps {
                ...
                sh '$DOCKER_COMPOSE exec -T web bash -c "mkdir -p $DOCKER_APP_ROOT/vendor $DOCKER_APP_ROOT/web/bundles; chown -R www-data:www-data $DOCKER_APP_ROOT/vendor $DOCKER_APP_ROOT/web/bundles;"'
