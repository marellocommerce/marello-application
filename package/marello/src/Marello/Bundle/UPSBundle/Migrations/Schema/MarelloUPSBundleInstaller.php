...
namespace Marello\Bundle\UPSBundle\Migrations\Schema;

use Doctrine\DBAL\Schema\Schema;
use Oro\Bundle\MigrationBundle\Migration\Installation;
use Oro\Bundle\MigrationBundle\Migration\QueryBag;

class MarelloUPSBundleInstaller implements Installation
{
    /**
     * {@inheritdoc}
     */
    ...
    public function createMarelloUPSShippingServiceTable(Schema $schema)
    {
        ...
        $table->addIndex(['country_code'], 'idx_d19a0f43f026bb7c');
    }
    ...
    protected function createMarelloUPSTransportShipServiceTable(Schema $schema)
    {
        ...
        $table->addIndex(['transport_id'], 'idx_2cdf5baf9909c13f');
        $table->addIndex(['ship_service_id'], 'idx_2cdf5baf37ca9b1d');
    }
    ...
    protected function createMarelloUPSTransportLabelTable(Schema $schema)
    {
        ...
        $table->addIndex(['transport_id'], 'idx_a984ab09909c13f');
        $table->addUniqueIndex(['localized_value_id'], 'uniq_a984ab0eb576e89');
    }
