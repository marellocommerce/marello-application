...
namespace Marello\Bundle\MagentoBundle\DependencyInjection\Compiler;
...
{
    const TAG = 'marello_magento.rest_response.converter';
    const PROVIDER_SERVICE_ID = 'marello_magento.converter.rest.response_converter_manager';
