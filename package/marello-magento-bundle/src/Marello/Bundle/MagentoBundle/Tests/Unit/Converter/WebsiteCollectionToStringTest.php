...
namespace Marello\Bundle\MagentoBundle\Tests\Unit\Converter;

use Doctrine\Common\Collections\ArrayCollection;

use Oro\Bundle\DataGridBundle\Datasource\ResultRecord;
use Marello\Bundle\MagentoBundle\Converter\WebsiteCollectionToString;
...
class WebsiteCollectionToStringTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $websiteMock1 = $this->createMock('Marello\Bundle\MagentoBundle\Entity\Website');
        $websiteMock1->expects($this->any())->method('getName')
            ->will($this->returnValue('website 1'));

        $websiteMock2 = $this->createMock('Marello\Bundle\MagentoBundle\Entity\Website');
