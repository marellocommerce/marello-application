define(function(require) {
    ...
    const MultipleEntityView = Backbone.View.extend({
        template: require('tpl-loader!marelloenterprisereplenishment/js/multiple-entity/templates/multiple-entities.html'),
        elementTemplate: require('tpl-loader!marelloenterprisereplenishment/js/multiple-entity/templates/multiple-entity.html'),
