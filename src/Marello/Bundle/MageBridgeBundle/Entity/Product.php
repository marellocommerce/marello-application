...
use Marello\Bundle\MageBridgeBundle\Model\ExtendProduct;
...
class Product extends ExtendProduct implements IntegrationAwareInterface
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Marello\Bundle\MageBridgeBundle\Entity\Website")
     * @ORM\JoinTable(name="marello_magento_prod_website",
