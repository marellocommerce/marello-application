...
use Marello\Bundle\PaymentBundle\Form\DataTransformer\DestinationPostalCodeTransformer;
...
{
    const BLOCK_PREFIX = 'marello_payment_methods_configs_rule_destination';
