...
use Marello\Bundle\PaymentBundle\Method\Event\MethodRemovalEventDispatcherInterface;
use Marello\Bundle\PaymentBundle\Method\EventListener\IntegrationRemovalListener;
...
class IntegrationRemovalListenerTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->channelType = 'payment_method';
