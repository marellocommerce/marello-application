...
use Marello\Bundle\ShippingBundle\Condition\HasApplicableShippingMethods;
...
class HasApplicableShippingMethodsTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $method = $this->createMock('Marello\Bundle\ShippingBundle\Method\ShippingMethodInterface');
