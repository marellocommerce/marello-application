...
namespace Marello\Bundle\UPSBundle\TimeInTransit\Result\Factory;

use Oro\Bundle\IntegrationBundle\Provider\Rest\Client\RestResponseInterface;
use Oro\Bundle\IntegrationBundle\Provider\Rest\Exception\RestException;
use Marello\Bundle\UPSBundle\Client\Result\UpsErrorResultTrait;
use Marello\Bundle\UPSBundle\TimeInTransit\Result\EstimatedArrivalInterface;
...
class TimeInTransitResultFactory implements TimeInTransitResultFactoryInterface
{
     ...
     * @return null|array
     */
    private function getOptionalParameter($parameterName, array $data)
    {
        $result = null;
