...
class LoadShippingServicesData extends AbstractFixture implements ContainerAwareInterface, DependentFixtureInterface
{
    ...
    public function loadSpecifiedCountryServices(ObjectManager $manager)
    {
        ...
        $filePath = $locator->locate('@MarelloUPSBundle/Migrations/Data/ORM/data/specified_country_services.csv');
    ...
    {
        $locator = $this->container->get('file_locator');
        $filePath = $locator->locate('@MarelloUPSBundle/Migrations/Data/ORM/data/eu_countries_services.csv');
    ...
    {
        $locator = $this->container->get('file_locator');
        $filePath = $locator->locate('@MarelloUPSBundle/Migrations/Data/ORM/data/unspecified_country_services.csv');
