...
namespace Marello\Bundle\UPSBundle\Tests\Unit\TimeInTransit\CacheProvider\Factory;

use Doctrine\Common\Cache\CacheProvider;
use Marello\Bundle\UPSBundle\Cache\Lifetime\LifetimeProviderInterface;
use Marello\Bundle\UPSBundle\TimeInTransit\CacheProvider\Factory\TimeInTransitCacheProviderFactory;
...
class TimeInTransitCacheProviderFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreateCacheProviderForTransport()
    {
        ...
        $this->cacheProvider
            ->expects(static::once())
            ->method('setNamespace')
            ->with('marello_ups_time_in_transit_' . 1);
