define(function(require) {
    ...
    var BaseEmailVariableView = require('oroform/js/app/views/wysiwig-editor/wysiwyg-editor-view');
    var _ = require('underscore');
    var $ = require('tinymce/jquery.tinymce.min');
    var txtHtmlTransformer = require('./txt-html-transformer');
    var LoadingMask = require('oroui/js/app/views/loading-mask-view');

    WysiwygEditorView = BaseEmailVariableView.extend({
        TINYMCE_UI_HEIGHT: 3,
        ...
        defaults: {
            enabled: true,
            plugins: ['textcolor', 'code', 'bdesk_photo', 'image'],
            menubar: false,
            toolbar: ['undo redo | bold italic underline | forecolor backcolor | bullist numlist | code | image bdesk_photo'],
            statusbar: false,
