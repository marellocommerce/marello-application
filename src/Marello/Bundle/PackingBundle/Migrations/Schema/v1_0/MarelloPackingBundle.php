...
namespace Marello\Bundle\PackingBundle\Migrations\Schema\v1_0;
 ...
 */
class MarelloPackingBundle implements Migration, ActivityExtensionAwareInterface
{
    ...
    protected function createMarelloPackingSlipTable(Schema $schema)
    {
        ...
        $table->addColumn('packing_slip_number', 'string', ['notnull' => false, 'length' => 255]);
