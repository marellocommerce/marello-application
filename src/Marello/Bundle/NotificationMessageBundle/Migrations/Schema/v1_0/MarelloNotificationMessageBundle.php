...
namespace Marello\Bundle\NotificationMessageBundle\Migrations\Schema\v1_0;
...
class MarelloNotificationMessageBundle implements Migration, ActivityExtensionAwareInterface, ExtendExtensionAwareInterface
{
    /**
