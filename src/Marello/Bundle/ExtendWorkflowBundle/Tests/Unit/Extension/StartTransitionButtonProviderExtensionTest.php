...
namespace Marello\Bundle\ExtendWorkflowBundle\Tests\Unit\Extension;
...
/**
 * Use the Oro test to see whether the override of the extension
 * is still working as it should
 * Class StartTransitionButtonProviderExtensionTest
 * @package Marello\Bundle\ExtendWorkflowBundle\Tests\Unit\Extension
 */
class StartTransitionButtonProviderExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIsAvailableException()
    {
        ...
        $this->expectExceptionMessage(
            ...
            'Marello\Bundle\ExtendWorkflowBundle\Extension\StartTransitionButtonProviderExtension. Can not determine availability'
        );
