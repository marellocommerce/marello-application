...
namespace Marello\Bundle\ExtendWorkflowBundle\Tests\Unit\Button;
...
/**
 * Use the Oro test to see whether the override of the button(s)
 * is still working as it should
 * Class TransitionButtonTest
 * @package Marello\Bundle\ExtendWorkflowBundle\Tests\Unit\Button
 */
class TransitionButtonTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertNotEquals(TransitionButton::DEFAULT_TEMPLATE, $this->button->getTemplate());
    }
