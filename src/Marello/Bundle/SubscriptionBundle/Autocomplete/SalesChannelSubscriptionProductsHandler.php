...
namespace Marello\Bundle\SubscriptionBundle\Autocomplete;

use Oro\Bundle\FormBundle\Autocomplete\SearchHandler;
use Doctrine\ORM\QueryBuilder;

class SalesChannelSubscriptionProductsHandler extends SearchHandler
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function getBasicQueryBuilder($channelId)
    {
        ...
        $queryBuilder->join('p.channels', 'sc')
            ...
            ->andWhere('p.type = :subscription_type')
            ->setParameter('channel_id', (int) $channelId)
            ->setParameter('subscription_type', 'subscription');
