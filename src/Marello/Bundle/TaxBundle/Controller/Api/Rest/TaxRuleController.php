...
class TaxRuleController extends RestController implements ClassResourceInterface
{
     ...
     *
     * @ApiDoc(
     *     description="Delete TaxRule from application",
     *     resource=true
     * )
     * @Security\AclAncestor("marello_tax_taxrule_delete")
     * @return Response
     */
    ...
    {
        return $this->get('marello_tax.taxrule.manager.api');
    }
