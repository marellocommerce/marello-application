...
class WarehouseGroupInventoryRebalanceListener
{
    ...
    {
        return ($entity instanceof WarehouseGroup);
    }
     ...
     */
    protected function triggerRebalance(WarehouseGroup $entity)
    {
        $productIds = [];
        $link = $entity->getWarehouseChannelGroupLink();
        if ($link) {
